										...
										<td >{{ $metodosPago->nombre }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('metodos-pagos.destroy', $metodosPago->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('metodos-pagos.show', $metodosPago->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('metodos-pagos.edit', $metodosPago->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
